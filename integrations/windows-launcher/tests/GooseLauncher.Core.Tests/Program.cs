...
namespace GooseLauncher.Core.Tests;

[TestClass]
public sealed class CoreTests
{
    [TestMethod]
    public void AcceptsSiblingFiles()
    {
    ...
    [TestMethod]
    public void RejectsDifferentParent()
    {
        using var workspace = TestWorkspace.Create();
    ...
    [TestMethod]
    public void PromptNamesSelectedFiles()
    {
    ...
    [TestMethod]
    public void FramesDesktopActivation()
    {
    ...
    [TestMethod]
    public void FramesDesktopCapabilities()
    {
        var frame = DesktopActivationProtocol.EncodeRequest(
            "request-1",
            "capabilities",
    ...
    [TestMethod]
    public void FramesDesktopSessionSelection()
    {
    ...
    [TestMethod]
    public async Task ActivatesDesktopOverUserPipe()
    {
    ...
    [TestMethod]
    public void LocatesUnifiedProduct()
    {
        using var workspace = TestWorkspace.Create();
        var desktop = workspace.File("Goose.exe");
    ...
    [TestMethod]
    public void RejectsProductWithoutDesktop()
    {
        using var workspace = TestWorkspace.Create();
    ...
    [TestMethod]
    public void RejectsProductWithoutCli()
    {
        using var workspace = TestWorkspace.Create();
    ...
    [TestMethod]
    public void BuildsInteractiveRunArguments()
    {
    ...
    [TestMethod]
    public void BuildsInteractiveSessionArguments()
    {
    ...
    [TestMethod]
    public void BuildsSelectedInteractiveRunArguments()
    {
    ...
    [TestMethod]
    public void ParsesLauncherOptions()
    {
        const string json = """
        {
          "schemaVersion": 1,
