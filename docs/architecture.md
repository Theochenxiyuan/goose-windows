...
2. **Companion shell**: one on-demand WinUI 3 process owns the overlay, protocol parsing, and pipe listener only while a task is being entered or run. It has no tray icon; Goose Desktop remains the sole resident tray application.
